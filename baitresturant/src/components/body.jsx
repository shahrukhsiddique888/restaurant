...
//       <div className="flex-shrink-0 sm:max-h-120 sm:overflow-auto  md:overflow-scroll">
//         <div className="grid  lg:grid-rows-2 lg:grid-cols-3 sm:grid-rows-1 sm:grid-cols-1 gap-8">
//           {menu.map((item, index) => (
...
export default function B() {
  ...
  return (
    <div className="card rounded-none">
      <div className="flex-shrink-0 grid grid-flow-col lg:grid-rows-2 lg:grid-cols-3 sm:grid-rows-1 sm:grid-cols-1 gap-8 overflow-auto">
        {menu.map((item, index) => (
